...
/**
 * Represents a reusable partial template and the data passed to it.
 */
class Partial
{
    private string $path;
    ...
    /**
     * Create a partial reference.
     *
     * @param string $path Relative path inside views/partials, without .php.
     */
    ...
    /**
     * Merge template data into the partial.
     *
     * Data is exposed to partial templates as variables prefixed with $data_.
     *
    ...
    /**
     * Return the data assigned to this partial.
     *
    ...
    {
        $baseErrorMsg = 'Error on setting Partial path: ';
        $path = trim($path);
    ...
    {
        $baseErrorMsg = 'Error while validating partial data format: ';
